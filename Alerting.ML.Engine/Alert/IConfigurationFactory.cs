...
/// <summary>
///     This interface defines a list of actions that will be performed on an <see cref="AlertConfiguration" /> during
///     training process.
...
{
    /// <summary>
    ///     Slightly changes values of each <typeparamref name="TConfiguration" />'s property with probability of
    ///     <paramref name="mutationProbability" />
    /// </summary>
    ...
    /// <returns>
    ///     Instance of alert configuration with randomly <see cref="ConfigurationParameterAttribute.Nudge" />'d
    ///     properties.
    /// </returns>
