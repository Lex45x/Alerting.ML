...
/// <summary>
///     <see cref="IAlert{T}" /> performance is evaluated against verified outages in a given time-period. Implementation
///     of this interface should provide such a list of outages.
/// </summary>
